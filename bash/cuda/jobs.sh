...
printf "universe = vanilla\nlog = logs/cuda/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.log\noutput = logs/cuda/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.out\nerror = logs/cuda/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.err\nrequest_gpus = 1\ngetenv = True\nqueue" > seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.sub
done
fi
done
done
done
printf "END OF CUDA JOB CREATION\n"
printf ".....................................................\n"
