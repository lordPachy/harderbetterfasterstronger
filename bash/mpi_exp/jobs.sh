...
printf "universe = parallel\n\nexecutable = scripts/mpi_exp/openmpiscript.sh\n\narguments = align_mpi_exp $(( 2**${seq_length} )) 0.25 0.25 0.25 $(( 2**${num_patterns} )) $(( 2**${pattern_mean_length} )) 16 $(( 2**${num_patterns} )) $(( 2**${pattern_mean_length} )) 16 $(( (2**${seq_length})/2 )) $(( (2**${seq_length})/2 )) M 609823\n\nshould_transfer_files = YES\n\ntransfer_input_files = align_mpi_exp\n\nwhen_to_transfer_output = on_exit_or_evict\n\noutput = logs/mpi_exp/nodes_${num_nodes}/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.out.\$(NODE)\nerror = logs/mpi_exp/nodes_${num_nodes}/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.err.\$(NODE)\nlog = logs/mpi_exp/nodes_${num_nodes}/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.log\n\nmachine_count = ${num_nodes}\nrequest_cpus = 1\n\ngetenv = True\nrequirements = (Machine != \"node126.di.rm1\")\nqueue\n" > nodes_${num_nodes}/seq_length_${seq_length}/patterns_${num_patterns}/mean_path_length_${pattern_mean_length}/${test_n}/job.job
done
fi
done
done
...
printf "END OF MPI EXP JOB CREATION\n"
printf ".....................................................\n"
